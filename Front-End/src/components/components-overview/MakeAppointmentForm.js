...
class MakeAppointmentForm extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      HID: "",
      DID: "",
      POID:localStorage.getItem("UserTypeID"),
      PID: "",
      TypeReason: "",
      Date: "",
      Time: "",
  ...
  componentDidMount() {
    ...
    fetch("https://cuddly-petz-backend-be41f8744064.herokuapp.com/api/v1/pethospital/")
      ...
      fetch(
        'https://cuddly-petz-backend-be41f8744064.herokuapp.com/api/v1/pet/?POID=' + localStorage.getItem("UserTypeID")
      )
        .then(response => response.json())
        .then(petList => {
  ...
  loadPetDetails() {
    this.setState({ POID: localStorage.getItem("UserTypeID") });
    fetch(
      'https://cuddly-petz-backend-be41f8744064.herokuapp.com/api/v1/pet/?POID=' + localStorage.getItem("UserTypeID")
    )
      .then(response => response.json())
            ...
            <Col>
              <Form>
                <Row form>
                  ...
                  <Col md="6" className="mb-3">
                    <label id="POID" htmlFor="DSpecialty">
                      Pet Owner
                    </label>
                    <FormSelect
                    ...
                    >
                      ...
                      {PetOwnerDetails.map((post, idx) => (
                        <option key={post._id} value={post._id}>
                          {post.OFirstName} {post.OLastName}
                        </option>
                      ))}
                    </FormSelect>
                  </Col>
                ...
                <InputGroup>
                  ...
                  <FormInput value="1000" id="Fee" onChange={() => {}} />
              ...
              <FormGroup>
                ...
                <FormTextarea id="Note" placeholder="Write a Note..." />
              </FormGroup>
              </Col>
            </Row> */}

                <Button onClick={this.submitAppoinmentsDetails}>
                  Add New Appointment
                </Button>
              </Form>
            </Col>
