...
import UpdateAddAppointmentForm from "../../components/components-overview/UpdateAddAppointmentForm";
        ...
        <Col lg="12" className="mb-4">
          <Card small>
            <CardHeader className="border-bottom">
              <h6 className="m-0">Make a Note for Appointment</h6>
            </CardHeader>
            <UpdateAddAppointmentForm />
          </Card>
        </Col>
      </Row>
    </Container>
